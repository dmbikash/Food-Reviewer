...
<!DOCTYPE html>
	...
	<body id="body">
		<?php  
			include('friends_profile_header.php');
		?>

		<!--cover area and pro pic-->
		<div id="cover_content" style="//background-color: yellow">
			<a href="profile.php" style="text-decoration: none;">Back to Your Profile</a>
<!--cover pic sec start-->			
...
<!--cover  pic-->
			<!--no  pic in friends profile		<img src="<?php echo $image ?>" id="cover_pic">   -->
<!--pro  pic sec start-->					
					<span >
						<?php  
							...
							{
								$image=$image_class->get_thumb_post( $user_data['profile_image'] );
							}
...
<!--pro  pic-->
                ...
                ?>
					...
					<?php echo $user_data['first_name'] . "'s " . 'Profile'."<br>" ;?>
